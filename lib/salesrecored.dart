...
import 'package:finalprojectflutter/salesinvoice.dart';
import 'package:flutter/material.dart';


class SalesRecored extends StatefulWidget {
...
class _SalesScreenState extends State<SalesRecored> {
  ...
  Future<void> addInvoice(
    ...
    await FirebaseFirestore.instance.collection('salesinvoice').add({
